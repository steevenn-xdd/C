/*
1.	Escribir un programa que pida un número y saque por pantalla su tabla de multiplicar 
...
hacer un código similar con cada una de las estructuras de ciclos)
*/
